...
- **Back-navigation restores your view** — on the server-paginated reports, your filters, search, grouping, sort, page number and page size are kept in the page's web address, so clicking into a record and pressing your browser's Back button returns you to the report exactly as you left it. You can also copy the address to bookmark or share a specific filtered view.
